...
<html lang="pt-br">
	...
	<body>
		...
		<div id="m1">	
			<img src="../imagens/imgcursoexcel.png">
		</div>
		<?php
		...
		?>
			<h2 class="c1">Excel Profissional</h2>
		<div class="paragrlogos2">
			<p class="pjustificado">
			O mercado de trabalho demanda profissionais aptos a operar ferramentas computacionais, entre elas o Excel. O
			<br>
			programa oferece recursos de planilhas eletrônicas, edição de fórmulas, funções e os mais variados gráficos,
			<br>
			trazendo agilidade nos processos de trabalho e facilitando o controle do negócio.
			<br>
			<br>
			Para quem quer se tornar um profissional dessa área, o Senac-RS oferece o curso de Excel Profissional. Com 24
			<br>
			horas de duração, a capacitação aborda todas as funções essenciais para as atividades de alto desempenho que
			<br>
			envolvem o setor de análise de dados.
			<br>
			<br>
			Venha conhecer nosso curso de Excel Profissional e se destaque no mercado de trabalho.
			</p>
		
			<img id="imgexcel" src="../imagens/imgexcel.png">
		</div>
		<footer>
			<span>
