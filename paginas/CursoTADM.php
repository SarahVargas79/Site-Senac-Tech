...
<html lang="pt-br">
	...
	<body>
		...
		<div id="m1">	
			<img src="../imagens/imgcursoadm.png">
		</div>
		<?php
		...
		?>
			<h2 class="c1">TÉCNICO EM ADMINISTRAÇÃO</h2>
		<div class="paragrlogos2">
			<p class="pjustificado">
			A formação vai te preparar para desempenhar funções voltadas para a gestão de pessoas, 
			<br>
			operações logísticas, gestão de materiaise patrimônio, marketing, vendas, finanças, entre
			<br>	
			outros.
			<br>
			<br>
			Por meio de uma proposta pedagógica adequada às exigências do mundo profissional,
			<br>
			o curso oferece nos momentos  presenciais* uma aprendizagem pautada por metodologias
			<br>
			que propiciam atuação por projetos, aulas práticas, teóricas, vivenciais e flexíveis com 
			<br>
			foco no mercado de trabalho. Mas também, momentos mediados por tecnologia**, em 
			<br>
			uma plataforma educacional própria, com conteúdo produzido por tutores altamente 
			<br>
			qualificados. Ambos os modos estimulam você a experimentar habilidades necessárias 
			<br>
			para os profissionais do futuro.
			<br>
			<br>
			...
			<br>
			<br>
			Ao final da formação você estará apto a atuar em empresas de diversos segmentos, além de   
			<br>
			poder participar de concursos em organizações públicas.
			<br>
			<br>
			Gostou da ideia de ser um profissional completo da área Administrativa? Venha para o curso 
			<br>
			Técnico em Administração do Senac-RS e mude de vida.
			<br>
			</p>
		
			<img id="imgadm" src="../imagens/imgadm.jpg">
		</div>
		<footer>
			<span>
