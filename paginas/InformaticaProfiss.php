...
<html lang="pt-br">
	...
	<body>
		...
		?>
			<h2 class="c1">Informática Profissinal - Office e Mobile</h2>
		<div class="paragrlogos2">
			<p class="pjustificado">
			Em um mundo cada vez mais digital, ter noções de informática é pré-requisito básico para quem quer
			<br>
			ingressar no mercado de trabalho ou busca uma recolocação profissional. Pensando nisso, o Senac
			<br>
			oferece o curso de Informática Profissional – Office Mobile.
			<br>
			<br>
			Com 120 horas de duração, a capacitação vai ensinar para você as principais ferramentas para a
			<br>
			operação de computadores, como: Windows Profissional, Word, Excel e Power Point, além de um
			<br>
			módulo exclusivo sobre internet e redes sociais.
			<br>
			<br>
			Conheça o curso de Informática Profissional – Office Mobile do Senac-RS.
			</p>
	
			<img id="imgofficemobile" src="../imagens/imgofficemobile.png">
		</div>
		<footer>
			<span>
