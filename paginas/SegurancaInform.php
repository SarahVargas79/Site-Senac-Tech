...
<html lang="pt-br">
	...
	<body>
		...
		<div id="m1">	
			<img src="../imagens/imgcursosegurancainform.png">
		</div>
		<?php
		...
		?>
			<h2 class="c1">Formação em Segurança da Informação</h2>
		<div class="paragrlogos2">
			<p class="pjustificado">
			A informação é o ativo mais vital para o funcionamento das empresas e com um número cada vez
			<br>
			maior de pessoas conectadas globalmente, existe consequentemente um aumento no compartilha-
			<br>
			-mento de dados confidenciais entre indivíduos e organizações. A proteção dessas informações 
			<br>
			envolve investimento em tecnologia, e também em profissionais capacitados para administrá-la.
			<br>
			<br>
			Sendo assim, com o curso de Formação em Segurança da Informação, você aprenderá a introdução 
			<br>
			à virtualização, o software Linux, os ambientes gráficos, a instalação do Kali Linux, a utilização de
			<br>
			comandos básicos para administração do sistema, a criação, alteração e remoção de usuários, a
			<br>
			configuração de permissões, a utilização de editores de texto, a configuração de rede, o gerencia-
			<br>
			-mento de pacotes, a instalação e inicialização de serviços.
			<br>
			<br>
			Também o Sistema Operacional Windows: a utilização de Gerenciador de processos, a inicialização de
			<br>
			serviços do sistema, a configuração de rede, a execução de comandos básicos e a instalação de serviços.
			<br>
			<br>
			O curso é destinado para todas as pessoas que possuem o ensino fundamental completo, conhecimento
			<br>
			básico de sistemas operacionais (Linux ou Windows) e a idade mínima exigida é de 16 anos.
			<br>
			<br>
			Às aulas são ministradas por docentes com experiência profissional. Após concluir este curso, estará 
			<br>
			disponível o certificado de Formação em Segurança da Informação, com validade nacional.
			</p>
	
			<img id="imgsecurity" src="../imagens/imgsecurity.png">
		</div>
		<footer>
			<span>
