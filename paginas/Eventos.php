...
<body>
	<div id="cabecalho">
		...
		<div id="week">	
			<div id="techweek">
				<h2 id="data">07 até 13 de Agosto</h2>
				<a id="week" href="Info.php">Tech Week | Semana da Tecnologia</a>
				<div id="end">
					<img src="../imagens/logoendereco.png">
					<p>
					Av. Venâncio Aires, 93 - Cidade Baixa, Porto 
					<br>
					Alegre
					</p>
				</div>
			...
			<div id="imgtechweek">
				<img src="../imagens/imgtechweek.jpg">
			</div>	
		</div>	
